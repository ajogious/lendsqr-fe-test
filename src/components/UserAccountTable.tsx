...
//   // Combine search and form filters
//   const filteredUsers = users.filter((user) => {
//     const query = searchQuery.toLowerCase();
//     const matchesSearch =
//       user.organization?.toLowerCase().includes(query) ||
...
//   return (
//     <div className={styles.container}>
//       <UserFilterForm onFilter={setFilters} allUsers={users} />
//       <div className={styles.tableContainer}>
//         <table className={styles.table}>
//           <thead>
//             <tr>
...
// import DropdownMenu from "./DropdownMenu";
// import UserFilterForm from "./UserFilterForm";
// import overlayStyles from "./UserFilterForm.module.scss";
...
//   const FilterIcon = () => (
//     <div className={styles.filterIcon} onClick={handleFilterClick}>
//       <div className={styles.filterLine} style={{ width: "14px" }}></div>
//       <div className={styles.filterLine} style={{ width: "10px" }}></div>
//       <div className={styles.filterLine} style={{ width: "4px" }}></div>
//     </div>
...
//           }}
//         >
//           <div className={overlayStyles.formContainer}>
//             <button
